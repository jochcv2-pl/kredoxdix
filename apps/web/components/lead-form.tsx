...
export default function LeadForm({
  ...
  socialNote?: string;
  /** Override CMS du libellé du bouton WhatsApp (fallback i18n si vide). */
  whatsappLabel?: string;
  /** Override CMS du libellé du bouton Messenger (fallback i18n si vide). */
          ...
          <div className={`btn-social-grid${single ? " single" : ""}`}>
            {wa && (
              ...
              >
                ...
                <span>{whatsappLabel?.trim() || t("whatsapp")}</span>
              </a>
            )}
            {ms && (
              <a
              ...
              >
                ...
                <span>{messengerLabel?.trim() || t("messenger")}</span>
              </a>
            )}
          </div>
        );
